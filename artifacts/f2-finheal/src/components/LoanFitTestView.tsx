...
export default function LoanFitTestView({
  ...
  return (
    <main className="loan-fit-view flex min-w-0 min-h-0 flex-1 flex-col overflow-hidden rounded-[20px] border border-gray-200 bg-white shadow-sm animate-fade-up delay-100">
