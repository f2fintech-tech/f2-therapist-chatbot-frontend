    ...
    return (
      <main className="emergency-fund-view flex min-w-0 min-h-0 flex-1 flex-col overflow-hidden rounded-[20px] border border-gray-200 bg-white shadow-sm animate-fade-up delay-100 dark:border-slate-800 dark:bg-slate-950">
        <div className="flex items-center gap-3 border-b border-gray-100 bg-white px-[16px] py-[14px] shrink-0 rounded-t-[20px] dark:border-slate-800 dark:bg-slate-950 sm:px-[20px] sm:py-[12px]">
          ...
          <button type="button" onClick={onBackToCatalog} className="h-[32px] w-[32px] rounded-[8px] border border-cyan-200 bg-cyan-50/50 text-cyan-700 flex items-center justify-center shadow-sm transition-all duration-200 hover:scale-105 hover:bg-cyan-100 active:scale-95 shrink-0 dark:border-cyan-900 dark:bg-cyan-950/30 dark:text-cyan-400 dark:hover:bg-cyan-900/50 cursor-pointer" aria-label="Back to test catalog"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4"><path d="m12 19-7-7 7-7"/><path d="M19 12H5"/></svg></button>
