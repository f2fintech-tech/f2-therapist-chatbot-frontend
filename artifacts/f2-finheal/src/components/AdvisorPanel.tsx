...
export default function AdvisorPanel({
  ...
  return (
    <main className="advisor-view flex min-w-0 min-h-0 flex-1 flex-col overflow-hidden bg-white rounded-[20px] shadow-sm border border-gray-200 animate-fade-up delay-100">
