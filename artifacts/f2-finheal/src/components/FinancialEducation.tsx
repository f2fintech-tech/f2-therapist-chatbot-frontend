...
const CONTENT: ContentItem[] = [
  {
    ...
    emoji: "B", bgColor: "#E6F1FB", articleUrl: "https://f2fintech.com/blogs/blogs-businessloan",
    date: "Recent",
  ...
  },
  {
    ...
    emoji: "G", bgColor: "#EAF3DE", articleUrl: "https://f2fintech.com/blogs/loans-gst2.0",
    date: "Recent",
  ...
  },
  {
    ...
    emoji: "O", bgColor: "#FAEEDA", articleUrl: "https://f2fintech.com/blogs/blog-OD",
    date: "Recent",
...
export default function FinancialEducation({ userId, onToggleSidebar }: Props) {
  const [tab, setTab] = useState<"all" | "articles" | "quiz">("all");
      ...
      <div style={{ padding: "20px 24px 0", borderBottom: "1px solid #f3f4f6", background: "white", borderRadius: "20px 20px 0 0" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "4px" }}>
          <div>
            ...
            <div style={{ fontSize: "13px", color: "#6b7280" }}>Learn finance your way</div>
          </div>
          {onToggleSidebar && <button onClick={onToggleSidebar} style={{ background: "none", border: "none", cursor: "pointer", fontSize: "20px" }}>Menu</button>}
        </div>
        ...
        <div style={{ background: "#fff7ed", border: "1px solid #fde68a", borderRadius: "10px", padding: "8px 14px", marginBottom: "14px", fontSize: "12px", color: "#92400e" }}>
          Tip: Always check your CIBIL score before applying for a loan.
        </div>

        <div onClick={() => setHistoryOpen(!historyOpen)}
          style={{ background: historyOpen ? "#F5F3FF" : "#f9fafb", border: `1.5px solid ${historyOpen ? "#7c3aed" : "#e5e7eb"}`, borderRadius: "12px", padding: "10px 14px", cursor: "pointer", marginBottom: "12px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            <div style={{ fontSize: "11px", color: "#6b7280" }}>Articles read</div>
            <div style={{ fontSize: "18px", fontWeight: 800, color: "#1e1b4b" }}>{read.length}</div>
          </div>
        ...
        <div style={{ display: "flex", gap: "4px" }}>
          {(["all", "articles", "quiz"] as const).map(t => (
            <button key={t} onClick={() => setTab(t)}
              ...
              {t === "all" ? "All" : t === "articles" ? "Articles" : "Quick quiz"}
            </button>
          ))}
        </div>
      </div>
          ...
          <>
            {!quizStarted && !quizDone && (
              <div style={{ textAlign: "center", padding: "24px 0" }}>
                ...
                <div style={{ fontSize: "13px", color: "#6b7280", marginBottom: "20px" }}>Answer 4 questions and get content matched to your financial situation.</div>
